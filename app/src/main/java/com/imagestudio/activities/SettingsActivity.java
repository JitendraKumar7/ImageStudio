...
import com.imagestudio.settings.CardViewStyleSetting;
import com.imagestudio.settings.ColorsSetting;
import com.imagestudio.settings.GeneralSetting;
import com.imagestudio.settings.MapProviderSetting;
import com.imagestudio.settings.SinglePhotoSetting;
import com.imagestudio.util.Security;
import com.imagestudio.views.SettingWithSwitchView;
...
public class SettingsActivity extends ThemedActivity {
    ...
    public void updateUiElements() {
        ...
        findViewById(com.imagestudio.R.id.setting_background).setBackgroundColor(getBackgroundColor());
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(com.imagestudio.R.string.settings));
    }
