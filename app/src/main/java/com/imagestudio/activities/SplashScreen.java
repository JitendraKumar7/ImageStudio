...
public class SplashScreen extends SharedMediaActivity {
    ...
    public final static String ACTION_OPEN_ALBUM = "com.imagestudio.OPEN_ALBUM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.imagestudio.R.layout.activity_splash);
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.imagestudio.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.imagestudio.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
