package com.imagestudio.activities;
...
import com.imagestudio.R;
import com.imagestudio.util.FingerprintHandler;
import com.imagestudio.util.Security;
...
public class SecurityActivity extends ThemedActivity {
    ...
    private void setPasswordDialog() {
        ...
        final View PasswordDialogLayout = getLayoutInflater().inflate(com.imagestudio.R.layout.dialog_set_password, null);
        final TextView passwordDialogTitle = (TextView) PasswordDialogLayout.findViewById(com.imagestudio.R.id.password_dialog_title);
        final CardView passwordDialogCard = (CardView) PasswordDialogLayout.findViewById(com.imagestudio.R.id.password_dialog_card);
        final EditText editTextPassword = (EditText) PasswordDialogLayout.findViewById(com.imagestudio.R.id.password_edittxt);
        final EditText editTextConfirmPassword = (EditText) PasswordDialogLayout.findViewById(com.imagestudio.R.id.confirm_password_edittxt);
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE, getString(com.imagestudio.R.string.cancel).toUpperCase(), new DialogInterface.OnClickListener() {
            @Override
        ...
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(com.imagestudio.R.string.ok_action).toUpperCase(), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (editTextPassword.length() > 3) {
                    if (editTextPassword.getText().toString().equals(editTextConfirmPassword.getText().toString())) {
                        if (Security.setPassword(editTextPassword.getText().toString())) {
                            ...
                            Toast.makeText(getApplicationContext(), com.imagestudio.R.string.remember_password_message, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(SecurityActivity.this, R.string.error_contact_developer, Toast.LENGTH_SHORT).show();
                            toggleResetSecurity();
                        }
                    } else {
                        Toast.makeText(getApplicationContext(), com.imagestudio.R.string.password_dont_match, Toast.LENGTH_SHORT).show();
                        toggleResetSecurity();
                    }
                } else {
                    Toast.makeText(getApplicationContext(), com.imagestudio.R.string.error_password_length, Toast.LENGTH_SHORT).show();
                    toggleResetSecurity();
                }
            }
        });
    ...
    private void toggleEnabledChild(boolean enable) {
        ...
        if(enable){
            ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_hidden_icon)).setColor(getIconColor());
            ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_hidden_title)).setTextColor(getTextColor());
            ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_delete_icon)).setColor(getIconColor());
            ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_delete_title)).setTextColor(getTextColor());
            ((ThemedIcon) findViewById(com.imagestudio.R.id.active_security_fingerprint_icon)).setColor(getIconColor());
            ((TextView) findViewById(com.imagestudio.R.id.active_security_fingerprint_item_title)).setTextColor(getTextColor());
        } else {
            ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_hidden_icon)).setColor(getSubTextColor());
            ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_hidden_title)).setTextColor(getSubTextColor());
            ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_delete_icon)).setColor(getSubTextColor());
            ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_delete_title)).setTextColor(getSubTextColor());
            ((ThemedIcon) findViewById(com.imagestudio.R.id.active_security_fingerprint_icon)).setColor(getSubTextColor());
            ((TextView) findViewById(com.imagestudio.R.id.active_security_fingerprint_item_title)).setTextColor(getSubTextColor());
        }
    }
    ...
    public void updateUiElements() {
        ...
        ((CardView) findViewById(com.imagestudio.R.id.security_dialog_card)).setCardBackgroundColor(getCardBackgroundColor());

        /** ICONS **/
        int color = getIconColor();
        ((ThemedIcon) findViewById(com.imagestudio.R.id.active_security_icon)).setColor(color);
        ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_hidden_icon)).setColor(color);
        ((ThemedIcon) findViewById(com.imagestudio.R.id.security_body_apply_delete_icon)).setColor(color);
        ((ThemedIcon) findViewById(com.imagestudio.R.id.active_security_fingerprint_icon)).setColor(color);

        /** TEXTVIEWS **/
        color = getTextColor();
        ((TextView) findViewById(com.imagestudio.R.id.active_security_item_title)).setTextColor(color);
        ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_on)).setTextColor(color);
        ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_hidden_title)).setTextColor(color);
        ((TextView) findViewById(com.imagestudio.R.id.security_body_apply_delete_title)).setTextColor(color);
        ((TextView) findViewById(com.imagestudio.R.id.active_security_fingerprint_item_title)).setTextColor(color);
