...
import com.imagestudio.data.filter.ImageFileFilter;
...
import static com.imagestudio.data.MediaHelper.scanFile;
...
public class BlackWhiteListActivity extends SharedMediaActivity {
    ...
    public void updateUiElements(){
        ...
        findViewById(com.imagestudio.R.id.rl_ea).setBackgroundColor(getBackgroundColor());
    }
