...
public class Security {
    ...
    public static void authenticateUser(final ThemedActivity activity, final AuthCallBack passwordInterface) {
        ...
        final View view = activity.getLayoutInflater().inflate(com.imagestudio.R.layout.dialog_password, null);
        final TextView passwordDialogTitle = view.findViewById(com.imagestudio.R.id.password_dialog_title);
        final CardView passwordDialogCard = view.findViewById(com.imagestudio.R.id.password_dialog_card);
        final EditText editTextPassword = view.findViewById(com.imagestudio.R.id.password_edittxt);
