package com.imagestudio.timeline
...
import com.imagestudio.data.filter.FilterMode
...
import com.imagestudio.data.sort.SortingMode
import com.imagestudio.data.sort.SortingOrder
import com.imagestudio.fragments.BaseMediaGridFragment
import com.imagestudio.interfaces.MediaClickListener
import com.imagestudio.items.ActionsListener
import com.imagestudio.progress.ProgressBottomSheet
import com.imagestudio.util.DeviceUtils
import com.imagestudio.util.MediaUtils.deleteMedia
import com.imagestudio.util.MediaUtils.shareMedia
import com.imagestudio.util.Security
import com.imagestudio.util.preferences.Defaults
...
class TimelineFragment : BaseMediaGridFragment(), ActionsListener {
    ...
    private lateinit var timeline_items: RecyclerView
    private lateinit var timelineAdapter: TimelineAdapter
    private lateinit var timelineListener: MediaClickListener
    private lateinit var gridLayoutManager: GridLayoutManager
    private lateinit var timeline_swipe_refresh_layout: SwipeRefreshLayout
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        timeline_items = view.findViewById(R.id.timeline_items)
        timeline_swipe_refresh_layout = view.findViewById(R.id.timeline_swipe_refresh_layout)
